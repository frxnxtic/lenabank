    ...
    public function createAccount(Request $request)
    {
        ...
        try {
            ...
            Transaction::create([
                ...
                "transaction_description" => "@Signup Bonus / Credit / @Lenabank",
        ...
        return redirect()->route("account.dashboard")->with("success","Welcome ".strtok(trim(Auth::user()->account->account_name), ' ').", You were credited with &#8372;".number_format($bonus)." as bonus from Lenabank.");
